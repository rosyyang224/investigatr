...
//     const { current_assignments: assignments } = investigation.data.attributes;
...
//                         <p>
//                             <b>Officer:</b> {assignment.data.attributes.officer.data.attributes.rank} {assignment.data.attributes.officer.data.attributes.first_name} {assignment.data.attributes.officer.data.attributes.last_name} (as of:{" "}
//                             <FormattedDate date={assignment.data.attributes.start_date} />)
//                         </p>
//                     </li>
//                 ))}
//             </ul>
